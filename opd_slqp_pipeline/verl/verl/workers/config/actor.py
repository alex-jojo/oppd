...
__all__ = ["SLQPConfig", "PolicyLossConfig", "ActorConfig", "FSDPActorConfig", "McoreActorConfig"]


@dataclass
class SLQPConfig(BaseConfig):
    """Configuration for the single-response latent quality objective."""

    enabled: bool = False
    calibration_path: Optional[str] = None
    loss_weight: float = 1.0
    slqp_only: bool = False
...
class PolicyLossConfig(BaseConfig):
    ...
    slqp: SLQPConfig = field(default_factory=SLQPConfig)
